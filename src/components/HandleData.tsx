...
export default function HandleData({ data }: HandleDataProps) {
    ...
    return (
        <div className="space-y-6 text-white">
            ...
            {/* Recuadro blanco con contador de visitas */}
            <div className="bg-white text-black text-center py-2 px-4 rounded-lg max-w-[250px] mx-auto">
                <p className="font-semibold text-sm">Visitas al perfil: {data.visits}</p>
            </div>
